...
8. Click **All properties**. 
    ...
    - The fields **resize_x** and **resize_y** are set to `@PUBLISH_WIDTH@` and `@PUBLISH_HEIGHT@` respectively, which define the resolution of the published frames. To view the values of these user-defined properties, click <img src="img/properties-icon.png" alt="properties icon" width=3% height=auto/> on the left toolbar.
