...
4. Expand **Model Warm-up**. The default warm-up tensor type is specified as "Random tensor" and the number of warm-up steps is set to 1. See the [documentation](https://go.documentation.sas.com/doc/en/espcdc/default/espxmllang/n0tippzgzce4uzn1kin6j79h732v.htm?fromDefault=) about model warm-up for more information.
